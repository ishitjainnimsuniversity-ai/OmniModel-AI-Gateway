...
try:
    ...
    try:
        from .providers import PROVIDERS_METADATA
        from .config import GatewayConfig
        from .adapters import UniversalAdapter
    except (ImportError, ModuleNotFoundError):
        from api.core.providers import PROVIDERS_METADATA
        from api.core.config import GatewayConfig
        from api.core.adapters import UniversalAdapter
